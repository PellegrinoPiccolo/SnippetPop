    ...
    <div className='flex flex-col'>
        ...
        <section className='flex flex-col gap-4 px-8 py-4'>
          ...
          <section className='flex justify-end gap-4 mt-4'>
              ...
              <button className='px-4 py-2 bg-blue-500/10 border border-blue-500/50 text-blue-500 rounded-lg hover:bg-blue-500/20 cursor-pointer' onClick={() => {type === "create" ? handleCreateCategory() : handleEditCategory()}}>{type === "create" ? "Create" : "Update"}</button>
          </section>
        </section>
    </div>
  )
